...
def main():
    ...
    parser = argparse.ArgumentParser(description="Pure lazy pipeline for massive datasets.")
    ...
    try:
        ...
        with console.status(f"[bold cyan]Streaming aggregated data to:[/bold cyan] {args.out_path}", spinner="dots"):

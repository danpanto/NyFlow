...
if not taxi_zones_path.exists(): exit(1)
...
jerarquia = {
    # Manhattan - Downtown
    'Chinatown': 'All Downtown', 'East Village': 'All Downtown', 'Financial District': 'All Downtown',
    'Greenwich Village': 'All Downtown', 'Little Italy': 'All Downtown', 'Soho': 'All Downtown',
    'Tribeca': 'All Downtown', 'West Village': 'All Downtown', 'Nolita': 'All Downtown',
    
    # Manhattan - Midtown
    'Chelsea': 'All Midtown', 'Gramercy Park': 'All Midtown', 'Midtown East': 'All Midtown',
    'Midtown West': 'All Midtown', 'Flatiron': 'All Midtown', 'Stuyvesant Town/PCV': 'All Midtown',
    
    # Manhattan - Upper East Side
    'Upper East Side': 'All Upper East Side', 'Roosevelt Island': 'All Upper East Side',
    
    # Manhattan - Upper West Side
    'Upper West Side': 'All Upper West Side',
    
    # Manhattan - Upper Manhattan
    'Central Harlem': 'All Upper Manhattan', 'East Harlem': 'All Upper Manhattan',
    'Hamilton Heights': 'All Upper Manhattan', 'Inwood': 'All Upper Manhattan',
    'Morningside Heights': 'All Upper Manhattan', 'Washington Heights': 'All Upper Manhattan',
...
df_rentas[cols_temporales] = df_rentas[cols_temporales].interpolate(method='linear', axis=1).bfill(axis=1).ffill(axis=1)

print("Imputación jerárquica completada.")


print("Mapeando zonas de taxi_zone_lookup.csv a las de los datos y mergeando para tener el id de zona con cada fila de los datos")
taxi_zone_mapping = {
    "Newark Airport": None,
    "Jamaica Bay": "Queens",
